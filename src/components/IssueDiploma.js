...
const IssueDiploma = () => {
  ...
  const handleFilterByStudentID = async () => {
    try {
      const web3 = window.web3;
      const contract = new web3.eth.Contract(diplomaNFTAbi, process.env.REACT_APP_CONTRACT_ADDRESS);
      const diplomaIds = await contract.methods.getDiplomasByStudentID(filter.studentID).call();
      setFilteredDiplomas(diplomaIds);
    } catch (error) {
      console.error('Error fetching diplomas by student ID:', error);
    }
  };

  const handleFilterByStudentName = async () => {
    try {
      const web3 = window.web3;
      const contract = new web3.eth.Contract(diplomaNFTAbi, process.env.REACT_APP_CONTRACT_ADDRESS);
      const diplomaIds = await contract.methods.getDiplomasByStudentName(filter.studentName).call();
      setFilteredDiplomas(diplomaIds);
    } catch (error) {
      console.error('Error fetching diplomas by student name:', error);
    }
  };
          ...
          <Card className="mt-4">
            <Card.Body>
              ...
              <Form>
                ...
                <Button variant="primary" className="me-3" onClick={handleFilterByStudentID}>Filter by Student ID</Button>
                <Form.Group className="mb-3">
                  <Form.Label>Student Name</Form.Label>
                  <Form.Control
                    type="text"
                ...
                <Button variant="primary" onClick={handleFilterByStudentName}>Filter by Student Name</Button>
              </Form>
              {filteredDiplomas.length > 0 && (
                <div className="mt-3">
                  <h5>Filtered Diplomas</h5>
                  <ul>
                    {filteredDiplomas.map((id) => (
...
//   const handleFilterByInstitution = async () => {
//     try {
//       const web3 = window.web3;
//       const contract = new web3.eth.Contract(diplomaNFTAbi, process.env.REACT_APP_CONTRACT_ADDRESS);
//       const tokenIds = await contract.methods.getDiplomasByInstitution(form.filterInstitutionName).call();
//       setFilteredDiplomas(tokenIds);
//     } catch (error) {
//       console.error('Error filtering diplomas by institution:', error);
//       alert('Failed to filter diplomas by institution');
//     }
//   };
...
//       const web3 = window.web3;
//       const contract = new web3.eth.Contract(diplomaNFTAbi, process.env.REACT_APP_CONTRACT_ADDRESS);
//       const tokenIds = await contract.methods.getDiplomasByStudentName(form.filterStudentName).call();
//       setFilteredDiplomas(tokenIds);
//     } catch (error) {
//       console.error('Error filtering diplomas by student name:', error);
//       alert('Failed to filter diplomas by student name');
//     }
//   };
...
//       const web3 = window.web3;
//       const contract = new web3.eth.Contract(diplomaNFTAbi, process.env.REACT_APP_CONTRACT_ADDRESS);
//       const tokenIds = await contract.methods.getDiplomasByStudentID(form.filterStudentID).call();
//       setFilteredDiplomas(tokenIds);
//     } catch (error) {
//       console.error('Error filtering diplomas by student ID:', error);
//       alert('Failed to filter diplomas by student ID');
//     }
//   };
...
//                 <Form.Control
//                   type="text"
//                   name="filterInstitutionName"
//                   value={form.filterInstitutionName}
//                   onChange={handleChange}
//                   placeholder="Institution Name"
//                 />
//                 <Button variant="primary" className="mt-2" onClick={handleFilterByInstitution}>Filter by Institution</Button>
//               </Form.Group>
//               <Form.Group className="mb-3">
//                 <Form.Label>Student Name</Form.Label>
//                 <Form.Control
...
//                   value={form.filterStudentName}
//                   onChange={handleChange}
//                   placeholder="Student Name"
//                 />
//                 <Button variant="primary" className="mt-2" onClick={handleFilterByStudentName}>Filter by Student Name</Button>
//               </Form.Group>
//               <Form.Group className="mb-3">
//                 <Form.Label>Student ID</Form.Label>
//                 <Form.Control
...
//                   value={form.filterStudentID}
//                   onChange={handleChange}
//                   placeholder="Student ID"
//                 />
//                 <Button variant="primary" className="mt-2" onClick={handleFilterByStudentID}>Filter by Student ID</Button>
//               </Form.Group>
//             </Form>
//             {filteredDiplomas.length > 0 && (
//               <div className="mt-3">
//                 <h5>Filtered Diplomas</h5>
//                 {filteredDiplomas.map((tokenId) => (
//                   <p key={tokenId}>Token ID: {tokenId}</p>
//                 ))}
//               </div>
//             )}
//           </Card.Body>
...
//   const [pendingRequests, setPendingRequests] = useState([]);
//   const [isAuthorizedIssuer, setIsAuthorizedIssuer] = useState(false);
//   const [issueDiplomaMessage, setIssueDiplomaMessage] = useState('');
//   const [retrieveDiplomaMessage, setRetrieveDiplomaMessage] = useState('');
...
//       const newTokenId = tx.events.DiplomaIssued.returnValues.tokenId; // Retrieve the token ID from the event log
//       setTokenId(newTokenId); // Set the token ID state
//       setIssueDiplomaMessage(`Diploma issued successfully! Token ID: ${newTokenId}`);
//       console.log('Diploma issued on blockchain with token ID:', newTokenId);
//     } catch (error) {
//       console.error('Error issuing diploma:', error);
//       setIssueDiplomaMessage('Failed to issue diploma');
//     }
//   };
...
//     } catch (error) {
//       console.error('Error retrieving diploma:', error);
//       setRetrieveDiplomaMessage('Failed to retrieve diploma');
//     }
//   };
...
//       const web3 = window.web3;
//       const contract = new web3.eth.Contract(diplomaNFTAbi, process.env.REACT_APP_CONTRACT_ADDRESS);
//       await contract.methods.requestAuthorization(form.requesterInstitutionName, form.requesterInstitutionID).send({ from: account });
//       setRequestMessage('Authorization request submitted successfully.');
//       await fetchPendingRequests(); // Refresh the pending requests
//     } catch (error) {
//       console.error('Error requesting authorization:', error);
...
//                 <Button variant="primary" type="submit">Issue Diploma</Button>
//               </Form>
//               {issueDiplomaMessage && <Alert variant="success" className="mt-3">{issueDiplomaMessage}</Alert>}
//             </Card.Body>
//           </Card>
//         </Col>
//         <Col>
...
//                 </div>
//               )}
//               {retrieveDiplomaMessage && <Alert variant="danger" className="mt-3">{retrieveDiplomaMessage}</Alert>}
//             </Card.Body>
//           </Card>
//         </Col>
//       </Row>
